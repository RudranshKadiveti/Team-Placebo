...
# We need to find `        if start_button:` and replace everything up to `    with tab_history:`
start_idx = content.find("        if start_button:")
end_idx = content.find("    with tab_history:")
